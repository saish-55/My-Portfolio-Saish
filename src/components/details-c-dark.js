...
import './details-c-dark.css'

const DetailsCDark = (props) => {
  return (
    <div className={`details-c-dark-container ${props.rootClassName} `}>
      <div className="details-c-dark-contact">
        <span className="details-c-dark-contact1">{props.contact}</span>
        <span className="details-c-dark-number">{props.Number}</span>
        <svg viewBox="0 0 1024 1024" className="details-c-dark-icon">
          <path
      ...
      <div className="details-c-dark-e-mail">
        <span className="details-c-dark-email">{props.email}</span>
        <span className="details-c-dark-e-address">{props.e_address}</span>
        <svg viewBox="0 0 1024 1024" className="details-c-dark-icon06">
          <path
      ...
      <div className="details-c-dark-address">
        <span className="details-c-dark-address1">{props.address}</span>
        <span className="details-c-dark-info">{props.info}</span>
        <svg viewBox="0 0 1024 1024" className="details-c-dark-icon08">
          <path
